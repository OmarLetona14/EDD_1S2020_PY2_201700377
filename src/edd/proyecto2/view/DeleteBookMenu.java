...
public class DeleteBookMenu extends javax.swing.JFrame {
     ...
     * @param book
     */
    public DeleteBookMenu(Book book){
        initComponents();
    ...
    private void deleteByISBN(){
        if(LocalData.currentUser.getCategories().searchNode(currentBook.getCategory().getCategoryName(), LocalData.currentUser.getRoot(), null)!=null){
            Category currentCategory = 
                LocalData.currentUser.getCategories().searchNode(currentBook.getCategory().getCategoryName(), LocalData.currentUser.getRoot(), null).getValue();
            currentCategory.getBooks().delete(currentBook);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteBookMenu(currentBook).setVisible(true);
            }
        });
    }

...
import edd.proyecto2.view.BookDetailsButton;
...
public class CellManagement extends DefaultTableCellRenderer{
    ...
    private BookDetailsButton detailsButton;
   ...
   //
    ...
    public CellManagement(String tipo, Book _book){
        this.tipo=tipo;
     ...
     //definimos colores por defecto
          ...
          colorFondo= colorFondoPorDefecto;
           ...
           if(tipo.equals("boton")){
               detailsButton = new BookDetailsButton(currentBook);
